...
public class ImageTracer {
	...
	public static IndexedImage colorquantization(ImageData imgd, byte[][] palette, HashMap<String, Float> options) {
		...
		double minratio = options.get("mincolorratio");
	...
	public static ArrayList<Double[]> fitseq(ArrayList<Double[]> path, double ltreshold, double qtreshold, int seqstart,
			int seqend) {
	...
	public static ArrayList<ArrayList<ArrayList<Double[]>>> batchtracelayers(
			ArrayList<ArrayList<ArrayList<Double[]>>> binternodes, double ltres, double qtres) {
	...
	public static void svgpathstring(StringBuilder sb, String desc, ArrayList<Double[]> segments, String colorstr,
		...
		if (roundcoords == -1) {
			...
			for (int pcnt = 0; pcnt < segments.size(); pcnt++) {
				if (segments.get(pcnt)[0] == 1.0) {
					sb.append("L ").append(roundtodec((double) (segments.get(pcnt)[3] * scale), roundcoords))
							.append(" ").append(roundtodec((double) (segments.get(pcnt)[4] * scale), roundcoords))
							.append(" ");
				} else {
					sb.append("Q ").append(roundtodec((double) (segments.get(pcnt)[3] * scale), roundcoords))
							.append(" ").append(roundtodec((double) (segments.get(pcnt)[4] * scale), roundcoords))
							.append(" ").append(roundtodec((double) (segments.get(pcnt)[5] * scale), roundcoords))
							.append(" ").append(roundtodec((double) (segments.get(pcnt)[6] * scale), roundcoords))
							.append(" ");
				}
			}
