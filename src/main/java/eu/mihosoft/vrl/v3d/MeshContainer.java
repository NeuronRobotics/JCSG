...
public class MeshContainer {
	...
	//
	// SubScene subScene = new SubScene(getRoot(), 100, 100, true,
	...
	// (ObservableValue<? extends javafx.geometry.Bounds> ov, javafx.geometry.Bounds
	// t, javafx.geometry.Bounds t1) -> {
	...
	// }
	//
	// private void setMeshScale(MeshContainer meshContainer, javafx.geometry.Bounds
	// t1, final Group meshView) {
	// double maxDim
	...
	//
	// //com.neuronrobotics.sdk.common.Log.error("scale: " + scale + ", maxDim: " +
	// maxDim + ", " + meshContainer);
