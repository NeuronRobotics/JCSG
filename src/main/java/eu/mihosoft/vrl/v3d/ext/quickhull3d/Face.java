 ...
 * offset, and a doubly-linked list of three <a href=HalfEdge>HalfEdges which
 * surround the face in a counter-clockwise direction.
 *
...
class Face {
	...
	public void computeNormal(Vector3d normal, double minArea) {
		...
		// throw new NumberFormatException("The computed area of this triangle is too
		// small: "+area);
		// }
