...
public interface PathHandler {
	 ...
	 *                if an error occured while processing the path
	 */
	void curvetoCubicRel(double x1, double y1, double x2, double y2, double x, double y) throws ParseException;
	 ...
	 *                if an error occured while processing the path
	 */
	void curvetoCubicAbs(double x1, double y1, double x2, double y2, double x, double y) throws ParseException;
	 ...
	 *                if an error occured while processing the path
	 */
	void curvetoCubicSmoothRel(double x2, double y2, double x, double y) throws ParseException;
	 ...
	 *                if an error occured while processing the path
	 */
	void curvetoCubicSmoothAbs(double x2, double y2, double x, double y) throws ParseException;
	 ...
	 *                if an error occured while processing the path
	 */
	void curvetoQuadraticRel(double x1, double y1, double x, double y) throws ParseException;
	 ...
	 *                if an error occured while processing the path
	 */
	void curvetoQuadraticAbs(double x1, double y1, double x, double y) throws ParseException;
	 ...
	 *                if an error occured while processing the path
	 */
	void arcRel(double rx, double ry, double xAxisRotation, boolean largeArcFlag, boolean sweepFlag, double x, double y)
	 ...
	 *                if an error occured while processing the path
	 */
	void arcAbs(double rx, double ry, double xAxisRotation, boolean largeArcFlag, boolean sweepFlag, double x, double y)
			throws ParseException;
}
