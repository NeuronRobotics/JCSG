...
//		});
	...
	public void setColor_OnUnionCSGShouldRetainColorsOnPolygons() {
		...
		// if (isLeftCube) {
		// assertEquals("Expected the left cube polygons to be blue", Color.BLUE,
		// polygon.getColor());
		// } else {
		// assertEquals("Expected the right cube polygons to be red", Color.RED,
		// polygon.getColor());
		// }
		// });
	}
	...
	public void setColor_OnCSGShouldChangeColorsOfAllPolygons() {
		CSG cube = new Cube(10).toCSG().setColor(Color.BLUE);
		assertEquals(Color.BLUE, cube.getColor());
...
//		});
	...
	public void setColor_OnUnionedCSGShouldChangeColorsOfAllPolygons() {
		...
		//
		// CSG union = cube1.union(cube2);
		// assertEquals("Expected the new object to get the default color",
		// CSG.getDefaultColor(), union.getColor());
		//
		// union.setColor(Color.BLUE);
		// union.getPolygons().forEach(polygon -> {
		// assertEquals("Expected the cube polygons to be another color", Color.BLUE,
		// polygon.getColor());
		// });
	}
	...
	public void setColor_OnDifferenceWithOptTypeBoundsShouldChangeColorsOfIntersectingPolygons() {
		...
		// assertEquals("Unexpected number of faces", 6,
		// difference.getPolygons().size());
		// difference.getPolygons().forEach(polygon -> {
		// Vector3d center = polygon.getBounds().getCenter();
		// if (center.equals(Vector3d.xyz(-5, 0, 0))) {
		// assertEquals("Expected the left face to have another color", Color.BLUE,
		// polygon.getColor());
		// } else if (center.equals(Vector3d.xyz(-0.5, -5, 0))) {
		// assertEquals("Expected the front face to have another color", Color.BLUE,
		// polygon.getColor());
		// } else if (center.equals(Vector3d.xyz(-0.5, 5, 0))) {
		// assertEquals("Expected the back face to have another color", Color.BLUE,
		// polygon.getColor());
		// } else if (center.equals(Vector3d.xyz(-0.5, 0, -5))) {
		// assertEquals("Expected the bottom face to have another color", Color.BLUE,
		// polygon.getColor());
		// } else if (center.equals(Vector3d.xyz(-0.5, 0, 5))) {
		// assertEquals("Expected the top face to have another color", Color.BLUE,
		// polygon.getColor());
		// } else if (center.equals(Vector3d.xyz(4, 0, 0))) {
		// assertEquals("Expected the right face to have another color", Color.RED,
		// polygon.getColor());
		// } else {
